...
import com.example.ghome.projectdz.Classwork.classwork8.ClassWork8Activity;
import com.example.ghome.projectdz.Classwork.classwork9.ClassWork9Activity;
import com.example.ghome.projectdz.Dz.dz6.Dz6Activity;
import com.example.ghome.projectdz.Dz.dz7.Dz7Activity;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Button classwork7button = (Button) findViewById(R.id.MainClasswork7Button);
        ...
        Button dz7buton = (Button) findViewById(R.id.MainDz7Button);
        dz7buton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        Button classwork8button = (Button) findViewById(R.id.MainClasswork8Button);
        ...
        Button classwork9button = (Button) findViewById(R.id.MainClasswork9Button);
